        ...
        <section className="w-full max-w-7xl mx-auto px-4 sm:px-10 lg:px-12 pt-6 sm:pt-10 lg:pt-14 pb-16">
          <div className="text-left" style={{ opacity: 1, transform: "none" }}>
            ...
            <p className="text-lg md:text-xl text-zinc-300 max-w-2xl">
             Secure organization elections staged and made public for eligble voters.
            </p>
          </div>
        </section>
              ...
              <div key={row?.id} className="rounded-3xl bg-slate-600/10 backdrop-blur-sm border border-slate-600/20 overflow-hidden hover:border-slate-600/40 transition-all duration-300 group shadow-lg" style={{ opacity: 1, transform: "none" }}>
                ...
                <div className="p-6">
                  <div className="mb-4">
                    ...
                    <p className="my-2 text-sm border border-zinc-700 text-zinc-300 flex flex-col space-y-2 rounded">
                      {/* Election starts at: April 23, 2026 5:00 AM and  */}
                      <button className="px-2 py-1 bg-slate-600/20 hover:bg-slate-600/30 text-white  transition-all duration-300 flex items-center justify-center gap-2 group text-sm font-medium border border-slate-600/30">
                        Election Opens : { moment(row.startAt).format("LLL") }
                      </button>
                      <button className="px-2 py-1 bg-slate-600/20 hover:bg-slate-600/30 text-white  transition-all duration-300 flex items-center justify-center gap-2 group text-sm font-medium border border-slate-600/30">
                        Election Closes : { moment(row.startAt).format("LLL") }
                      </button>
                    </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-3">
                      <Link to={`/vote/election?page=${row.tag}`}
                        className="flex-1 px-4 py-3 bg-[#E3F09B] text-black rounded-2xl hover:from-[#6d28d9]/90 hover:to-purple-600/90 transition-all duration-300 flex items-center justify-center gap-2 group text-base font-bold shadow-lg"
                      >
                        Goto Election Page
                      </Link>
